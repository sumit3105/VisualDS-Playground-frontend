...
export default function Playground() {
    ...
    const handleGenerateCode = async () => {
        ...
        try {
            ...
            const response = await fetch(`${API_URL}api/algorithm/generate`, {
                method: "POST",
                headers: {
            ...
            const saveResponse = await fetch(`${API_URL}Api/codes/user/3`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${token}`,
    ...
    const handleAiResizeMouseMove = (e) => {
        ...
        if (isResizingWidthRef.current && aiGeneratorRef.current) {
            const parentWidth =
                aiGeneratorRef.current.parentElement.offsetWidth;
            ...
            <div className="p-6">
                ...
                >
                    ...
                    <div
                        ...
                        onMouseDown={(e) =>
                            handleAiResizeMouseDown(e, "height")
                        }
                        style={{ opacity: 0.7 }}
                    />
                </div>
